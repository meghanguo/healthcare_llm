...
parser.add_argument(
    ...
    choices=["bert-base-uncased", "albert-base-v2", "roberta-base", "gpt2", "ClinicalBERT", "Bio_ClinicalBERT", "gpt2-med"],
...
if __name__ == "__main__":
    ...
    if args.model_name_or_path == "ClinicalBERT":
        model = getattr(models, args.model)("medicalai/ClinicalBERT")
    elif args.model_name_or_path == "Bio_ClinicalBERT":
        model = getattr(models, args.model)("emilyalsentzer/Bio_ClinicalBERT")
    elif args.model_name_or_path == "gpt2-med":
        model = getattr(models, args.model)("Locutusque/gpt2-large-medical")
    else:
        model = getattr(models, args.model)(args.model_name_or_path)
    model.eval()

    if args.model_name_or_path == "ClinicalBERT":
        tokenizer = transformers.BertTokenizer.from_pretrained("medicalai/ClinicalBERT")
    elif args.model_name_or_path == "Bio_ClinicalBERT":
        tokenizer = transformers.BertTokenizer.from_pretrained("emilyalsentzer/Bio_ClinicalBERT")
    elif args.model_name_or_path == "gpt2-med":
        tokenizer = transformers.GPT2Tokenizer.from_pretrained("Locutusque/gpt2-large-medical")
    else:
